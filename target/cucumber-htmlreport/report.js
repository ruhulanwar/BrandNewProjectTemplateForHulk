$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("BrowseConditionByNur.feature");
formatter.feature({
  "line": 2,
  "name": "Drug Browse Condition",
  "description": "",
  "id": "drug-browse-condition",
  "keyword": "Feature",
  "tags": [
    {
      "line": 1,
...
formatter.background({
  "line": 4,
  "name": "Given: The user is on drugs.com homepage.",
  "description": "",
  "type": "background",
  "keyword": "Background"
});
formatter.scenario({
  "line": 6,
  "name": "The user browses  condition",
  "description": "",
  "id": "drug-browse-condition;the-user-browses--condition",
  "type": "scenario",
  "keyword": "Scenario"
});
formatter.step({
  "line": 7,
  "name": "User clicks on Browse Conditions on the homepage",
  "keyword": "When "
});
formatter.step({
  "line": 8,
  "name": "User clicks on Alphabet A below the condition",
  "keyword": "And "
});
formatter.step({
  "line": 9,
  "name": "Clicks on Abdominal Pain under Common heading",
  "keyword": "And "
});
formatter.step({
  "line": 10,
  "name": "user should get all information realted to abdominal pain",
  "keyword": "Then "
});
formatter.match({
...
formatter.step({
  "line": 8,
  "name": "the user clicks on new drugs on the top of the page",
  "keyword": "When "
});
formatter.step({
  "line": 9,
